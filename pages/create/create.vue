...
<view class="vote_type">
	...
	<view class="type_list">
		<view class="type_item" @click="goWord">
		 <view class="type_item_log_word"/>
			...
			<view class="type_item" @click="goPic" >
			...
			margin-bottom: 15px;
			.type_item_log_word{
			background: url("../../static/tabbar/image/word.png") no-repeat
			center;
			width: 3.0rem;
			height: 3.0rem;
			...
			.type_item_log_pic{
			background: url("../../static/tabbar/image/pic.png") no-repeat
			center;
			width: 3rem;
			height: 3.0rem;
			margin-right: 0.425rem;
